...
Handles digest generation and email sending with SendGrid
"""
...
try:
    ...
    logger.warning("SendGrid not available - email sending disabled")
...
class EmailDigestService:
    def __init__(self):
        ...
        self.from_email = os.getenv("FROM_EMAIL", "noreply@ai-daily.com")
        self.from_name = os.getenv("FROM_NAME", "AI Daily")
        self.sg = None
        
        if not SENDGRID_AVAILABLE:
            logger.warning("SendGrid library not available - email sending disabled")
            return
        ...
        if self.sendgrid_api_key:
            ...
            logger.warning("No SENDGRID_API_KEY found - email sending disabled")
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
            ...
            <div style="margin-top: 48px; padding: 24px; background: #f1f5f9; border-radius: 12px; text-align: center;">
                ...
                <p style="margin: 0; color: #64748b; font-size: 12px;">
                    <a href="https://ai-digest.vercel.app" style="color: #3b82f6; text-decoration: none;">Update preferences</a> • 
                    <a href="mailto:support@ai-daily.com?subject=Unsubscribe" style="color: #3b82f6; text-decoration: none;">Unsubscribe</a>
                </p>
...
Manage preferences: https://ai-digest.vercel.app
...
AI Daily • Making AI news accessible to everyone
    ...
    async def send_digest_email(self, user_data: Dict, articles: List[Dict], multimedia_content: Dict = None) -> bool:
        ...
        try:
            ...
            if response.status_code in [200, 202]:
                logger.info(f"Digest email sent successfully to {user_email}")
                return True
            else:
    ...
    def generate_welcome_email_html(self, user_data: Dict) -> str:
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
            ...
            <div style="text-align: center; margin: 32px 0;">
                <a href="https://ai-digest.vercel.app" style="display: inline-block; padding: 12px 24px; background: #3b82f6; color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">Customize Your Preferences</a>
            </div>
    ...
    async def send_welcome_email(self, user_data: Dict) -> bool:
        ...
        try:
            ...
            # Create email
            subject = "🤖 Welcome to AI Daily - Your AI News Journey Begins!"
...
Customize your preferences: https://ai-digest.vercel.app

Thank you for subscribing to AI Daily!
